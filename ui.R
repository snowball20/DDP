...
shinyUI(
  navbarPage("Shiny Application",
             ...
             tabPanel("Go back to my Github repository",
                        a("https://github.com/snowball20/DDP.git"),
                        hr(),
                        h2("I hope you like it"),
                        h2("The name of the repository is DDP")
             )
  )
)